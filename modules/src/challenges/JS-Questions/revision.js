...
function calculateTotalFare1(trainNumbers, passenger){
  const matchTrainNumber = trainsDetails.find((train) => train.trainNumber === trainNumbers);

  if(matchTrainNumber){
    const trainFare = matchTrainNumber.fare
    const totalCost = trainFare * passenger;
    return totalCost
  }
}
console.log(calculateTotalFare1(54678, 2));  