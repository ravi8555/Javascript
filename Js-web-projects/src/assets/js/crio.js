...
//   // You only need to implement this function.
//   if (
//     name.charAt(0) === dish.charAt(0) &&
//     name.charAt(name.length - 1) === dish.charAt(dish.length - 1)
//   ) {
//     return console.log(`${name} starts with** ${name.charAt(
//       0
//     )} and ends with ${name.charAt(
//       name.length - 1
//     )}** whereas ${dish} starts and
//     ends with **${dish.charAt(0)} **and **${dish.charAt(
//       dish.length - 1
//     )} **respectively. Hence the output is true.`)
//   } else {
